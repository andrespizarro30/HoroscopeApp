...
import com.afsoftwaresolutions.horoscopeapp.domain.useCases.GetPredictionUseCase
...
class HoroscopeDetailViewModel @Inject constructor(private val getPredictionUseCase: GetPredictionUseCase):ViewModel(){
    ...
    fun getHoroscope(sign: HoroscopeModel){
        ...
        viewModelScope.launch {
            ...
            val result = withContext(Dispatchers.IO){getPredictionUseCase(sign.name)} //BACKGROUND THREAD
            //MAIN THREAD
            if(result!=null){
